...
consteval std::uint32_t port_to_base_address () {
    if (port == gpio_ports::gpiof) { return GPIOF_BASE_ADDR; }
    else if (port == gpio_ports::gpiod) { return GPIOD_BASE_ADDR; }
    else if (port == gpio_ports::gpioc) { return GPIOC_BASE_ADDR; }
    else if (port == gpio_ports::gpiob) { return GPIOB_BASE_ADDR; }
