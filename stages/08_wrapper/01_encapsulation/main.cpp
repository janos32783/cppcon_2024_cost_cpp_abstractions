...
static void MX_GPIO_Init(void)
{
    hal::gpio::CPort<hal::gpio::ports::port_a>::init();
    hal::gpio::CPort<hal::gpio::ports::port_b>::init();
    hal::gpio::CPort<hal::gpio::ports::port_c>::init();

    {
        hal::gpio::CPin pin { hal::gpio::ports::port_c, hal::gpio::pins::pin_13 };
        pin.set_pin_output();
    }
    {
        hal::gpio::CPin pin { hal::gpio::ports::port_a, hal::gpio::pins::pin_00 };
        pin.set_pin_output();
    }
    {
        hal::gpio::CPin pin { hal::gpio::ports::port_a, hal::gpio::pins::pin_01 };
        pin.set_pin_output();
    }
    {
        hal::gpio::CPin pin { hal::gpio::ports::port_a, hal::gpio::pins::pin_04 };
        pin.set_pin_output();
    }
    {
        hal::gpio::CPin pin { hal::gpio::ports::port_a, hal::gpio::pins::pin_08 };
        pin.set_pin_output();
    }
